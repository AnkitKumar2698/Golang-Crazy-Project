...
func main() {
	...
	iconWeather := canvas.NewImageFromFile("C:\\Users\\Ankit Sharma\\Desktop\\golang crazy\\Project\\weather.jpg")
	...
	iconCalc := canvas.NewImageFromFile("C:\\Users\\Ankit Sharma\\Desktop\\golang crazy\\Project\\calculator.png")
	...
	iconGallery := canvas.NewImageFromFile("C:\\Users\\Ankit Sharma\\Desktop\\golang crazy\\Project\\gallery.png")
	...
	iconMusic := canvas.NewImageFromFile("C:\\Users\\Ankit Sharma\\Desktop\\golang crazy\\Project\\music.jpg")
	iconMusic.FillMode = canvas.ImageFillContain
	musicbt := widget.NewButton("      \n            \n        ", func() {
		musicPlayer(a)
	})
	musicBtn := container.NewPadded(iconMusic, musicbt)
	iconSettings := canvas.NewImageFromFile("C:\\Users\\Ankit Sharma\\Desktop\\golang crazy\\Project\\settings.png")
    ...
    iconTerminal:= canvas.NewImageFromFile("C:\\Users\\Ankit Sharma\\Desktop\\golang crazy\\Project\\terminal.png")
...
func gallery(a fyne.App) {
	...
	filepath := "C:\\Users\\Ankit Sharma\\Desktop\\golang crazy\\Project\\wallpaper"
